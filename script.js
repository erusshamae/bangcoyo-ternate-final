...
// Create a new list item for the first name
const firstNameListItem = document.createElement('li');
const firstNameNavLink = document.createElement('a');
firstNameNavLink.href = "#profile";
firstNameNavLink.classList.add("link");
firstNameNavLink.textContent = `${firstName}'s Profile`;
firstNameListItem.appendChild(firstNameNavLink);
firstNameListItem.appendChild(firstNameNavLink).style.color = "yellow";



// Insert the first name list item before the logout list item
const logoutListItem = document.querySelector('.logout');
logoutListItem.parentNode.insertBefore(firstNameListItem, logoutListItem);
